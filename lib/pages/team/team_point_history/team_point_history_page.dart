...
import 'package:dting/pages/team/team_point_history/team_point_history_controller.dart';
...
class TeamPointHistoryPage extends GetView<TeamPointHistoryController> {
  const TeamPointHistoryPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidgets.getAppBar(
        title: "teamPointRecord".tr,
