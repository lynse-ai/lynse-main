...
class ConnectDeviceController extends GetxController {
  ...
  List<DeviceInfoModel> get deviceList {
    if (appController.bindDeviceList.isEmpty) {
      DeviceService.getDeviceList().then((list) {
        appController.bindDeviceList.value = list;
        return list;
      });
      return [];
    } else {
      return appController.bindDeviceList;
    }
  }
