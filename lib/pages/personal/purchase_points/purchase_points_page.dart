...
class PurchasePointsPage extends GetView<PurchasePointsController> {
  const PurchasePointsPage({super.key});
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 2.w),
                  Text(
                    "${point.discountRate!.toString()}${"fold".tr}",
                  ).descText(
                    fontSize: 12,
